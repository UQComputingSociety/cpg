...
...and then go to the middle, and split the list in two based on whether the number is bigger?
...
[7]
```
Here it took us only four steps to find 7, whereas above it took us 7!
